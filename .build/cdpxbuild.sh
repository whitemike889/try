...
curl https://github.com/OmniSharp/omnisharp-roslyn/releases/download/v1.29.0-beta1/omnisharp-linux-x64.tar.gz -o ./MLS.Agent/obj/Docker/publish/omnisharp.tar.gz
