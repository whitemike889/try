...
```csharp --project ./MatrixFactorization_MovieRecommendation/MovieRecommendation/MovieRecommendation.csproj --session movieRecommendation  ./MatrixFactorization_MovieRecommendation/MovieRecommendation/Program.cs
